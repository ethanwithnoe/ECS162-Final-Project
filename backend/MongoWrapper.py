...
class MongoWrapper:
    ...
    # Insert a single document into the specified collection in the specified database
    ...
    # Find a singe document in the specified collection in the specified database
    ...
    # Find all documents in the specified collection in the specified database
    ...
    # Update a singe document in the specified collection in the specified database
    ...
    # Delete all documents in the specified collection in the specified database
    # A document is a match if all keys:value pairs in the query dict are present and match
    def deleteDocument(self, dbName, colName, jsonObj={}):
        return self.getCollection(dbName, colName).delete_many(jsonObj)
